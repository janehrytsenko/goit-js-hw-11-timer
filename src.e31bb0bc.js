...
var daysEl = document.querySelector('span[data-value="days"]');
var hoursEl = document.querySelector('span[data-value="hours"]');
var minsEl = document.querySelector('span[data-value="mins"]');
var secsEl = document.querySelector('span[data-value="secs"]');
...
var CountdownTimer = /*#__PURE__*/function () {
  ...
  _createClass(CountdownTimer, [{
    ...
    value: function getDeltaTime() {
      ...
      var deltaTime = this.targetDate - currentTime;
    ...
    key: "updateClockface",
    value: function updateClockface(days, hours, mins, secs) {
      daysEl.textContent = "".concat(days);
      hoursEl.textContent = "".concat(hours);
      minsEl.textContent = "".concat(mins);
      secsEl.textContent = "".concat(secs);
    }
  }]);
